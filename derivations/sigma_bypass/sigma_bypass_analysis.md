...
**Boundary Theorem 6 (BT-6, reduced model):**  
...
The **geometric test on the reduced model supports Boundary Theorem 6 (BT-6)**: no system admits a harmonic 2-form, so no sigma-field candidate emerges from this discrete de Rham complex.
...
**Status: Boundary Theorem 6 (BT-6) holds in the reduced model, but the full 4-manifold topology remains untested.**
