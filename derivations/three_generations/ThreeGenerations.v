...
(*                                                                            *)
(* АНГЛИЙСКИЙ: None of the five candidate mechanisms derives exactly 3        *)
...
(*                                                                            *)
(* ЧЕСТНЫЙ ВЕРДИКТ: Геометрия H4/600-клетки + 2I не порождает число 3       *)
(* автоматически из первых принципов. Это значимый отрицательный результат, *)
(* укрепляющий no-go случай для H4-базированного объединения.               *)
(******************************************************************************)
