...
**Principle:** не врать — report what the analysis finds, even when it undermines marketing copy
...
2. No-Go Theorems (Coq formalizations + markdown descriptions)
...
### 7. NGTs Are Not No-Go Theorems (HIGH — DOCUMENTED)
...
**Fix:** Documented in this report. Recommendation: rename "No-Go Theorems" to "Construction Failures" or "Negative Results" in future publications.
...
10. **Rename NGTs to "Negative Results" in all publications.** Stop calling them "No-Go Theorems" — they are not impossibility results.
...
*Report generated by Wave 20 deep RAG analysis. Principle: не врать.*
