% LEGACY DOCUMENT (historical paper wave13)
...
% Trinity S3AI — Boundary-Mapping Research Program in Geometric Unification
...
Our 	extbf{boundary theorems} include five Boundary theorems:
...
E$_6$/E$_7$ plumbing discretization mismatch (BT-5). We discuss the
...
\S\ref{sec:boundary} presents the five Boundary theorems. \S\ref{sec:discussion}
