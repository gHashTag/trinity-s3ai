% Trinity S³AI — Constructive Negative Result in Geometric Unification
...
Our \textbf{negative results} include seven No-Go theorems:
...
E$_6$/E$_7$ plumbing discretization mismatch (NGT-5); F$_4$ Yukawa scan
fails to produce 3-generation hierarchy without external parameters (NGT-7).
...
\S\ref{sec:nogo} presents the five original No-Go theorems.
\S\ref{sec:extended} reports new negative results from Waves 16--17
...
% ============================================================
\section{Extended Negative Results (Waves 16--17)}\label{sec:extended}
...
\begin{nogo}[F$_4$ three-generation hierarchy, Wave 16.1]\label{nogo:f4}
...
\begin{verbatim}
  ...
  Refutations:   7 (No-Go Theorems 1--5, 7)
  Files:        79 .v files
