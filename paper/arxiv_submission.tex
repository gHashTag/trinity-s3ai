...
\textit{Falsification criteria (pre-registered):} If DUNE measures $\delta_{CP} \in [50^\circ, 80^\circ]$, Trinity is confirmed at $\geq$3$\sigma$. If DUNE measures $\delta_{CP} > 100^\circ$ or $\delta_{CP} < 30^\circ$, Trinity's PMNS sector is falsified at $\geq$3$\sigma$. The Jarlskog invariant $|J_{\text{Trinity}}| = 0.0327$ agrees with $|J_{\text{exp}}| = 0.0295$ at the 10\% level, suggesting the overall CP violation magnitude is correct even if the phase is tensioned.
...
\begin{itemize}
    \item Measure $\delta_{CP} \in [50^\circ, 80^\circ]$ $\to$ Trinity confirmed at $\geq$3$\sigma$
