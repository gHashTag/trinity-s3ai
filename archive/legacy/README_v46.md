...
|----------|-------------|-------------|--------|
| Coq compilation | 9/18 (50%) | **see [COQ_HONEST_STATUS.md](../../docs/status/COQ_HONEST_STATUS.md)** — 79 .v files / 1325 Qed / 123 unproven (compile status per-file, not blanket %) |
...
| 7 | **Coq 50% (9/18)** | 🟡 **see [COQ_HONEST_STATUS.md](../../docs/status/COQ_HONEST_STATUS.md)** | 79 .v files / 1325 Qed / 123 unproven obligations (categorized: PHYSICAL_AXIOM, NUMERICAL_FIT, MATH_TODO, LIBRARY_GAP, REFUTED, Track B, scaffolding) |
...
**Result: see [COQ_HONEST_STATUS.md](../../docs/status/COQ_HONEST_STATUS.md) for canonical metrics** — 79 .v files, 1325 Qed total, 123 unproven obligations. HiggsPrediction.v specifically: 0 Admitted (verified).
