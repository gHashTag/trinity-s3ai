...
| [`gf16_bench_results.json`](gf16_bench_results.json) | `t27/conformance/gf16_bench_results.json` | MSE 0.000234, latency 4.5–7.2 ns/op, 35/35 RTL tests pass |
...
| [`RELATED_WORK.md`](RELATED_WORK.md) | **This repo** | 18 prior-art entries with honest gap analysis |
| [`FORMAT-SPEC-001.json`](FORMAT-SPEC-001.json) | `t27/conformance/FORMAT-SPEC-001.json` | GoldenFloat family SSOT |
| `rtl/` | `t27/rtl_gen/` | Verilog RTL (gf16_mul.v, gf16_add.v, gf16_dot4.v, testbenches) |
...
| 0x47C0 silicon anchor | `open_conjecture` | `silicon_anchor.md` §1–2 — design documented, silicon pending |
| TinyTapeout TTSKY26a | `open_conjecture` | `silicon_anchor.md` §3.1 — single-chip submitted, awaiting silicon ~Aug 2026 |
| Three Crowns TTSKY26b | `open_conjecture` | `silicon_anchor.md` §3.2 — 21 PRs merged, awaiting silicon ~Nov 2026 |
| ~1 GOPS @ ~50 MHz @ ~1 W | `open_conjecture` | `silicon_anchor.md` §4.2 — RTL projection, not measurement |
...
# GF16 conformance tests (bias=31 canonical)
python3 gf16_ref.py
...
cat gf16_bench_results.json | python3 -m json.tool
cat bpb_results.json | python3 -m json.tool

# Coq hardware models
cd ../../proofs/trinity/coq_models
