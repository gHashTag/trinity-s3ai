...
- The **σ-field is absent** (No-Go Theorem 6), blocking dynamic Higgs mass generation.
...
3. **σ-field absence**: State No-Go Theorem 6 clearly. Discuss workarounds or declare it an open problem.
