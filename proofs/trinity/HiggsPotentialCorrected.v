...
(*                                                                            *)
(*  This file provides interval bounds on fitted Higgs potential parameters.  *)
(*  The formulas are NOT derived from the Trinity spectral action.            *)
(*                                                                            *)
(*  The 6% VEV gap arises from using the bare geometric lambda = 1/phi^4     *)
(*  without the spectral action cutoff normalization. The spectral action     *)
(*  itself predicts m_H ≈ 132.9 GeV (refuted at 55.6σ). The Trinity formula  *)
(*  m_H = 4*phi^3*e^2 = 125.2 GeV is a RETROSPECTIVE FIT, not a derivation.  *)
(*                                                                            *)
(*  Status: POSTULATED -> FITTED (with ~6% theoretical uncertainty)          *)
(*                                                                            *)
(******************************************************************************)
