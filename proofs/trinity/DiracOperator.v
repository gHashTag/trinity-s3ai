...
(*    This proves [D, L_a] = 0 (commutativity) for quaternionic multiplication.*)
(*    This is NOT the full Connes first-order condition [[D,a], JbJ^-1]=0,    *)
(*    which remains MATH_TODO in SpectralTripleAxioms.v.                      *)
