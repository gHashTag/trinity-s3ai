...
(*                                                                            *)
(*  This file computes the spectral action coefficient a_4(D^2) for the      *)
(*  600-cell using its Schlafli symbol {3,3,5}. This is a CALCULATION, not   *)
(*  a derivation from H4 invariants to SM parameters. All formulas are fitted.*)
(*                                                                            *)
