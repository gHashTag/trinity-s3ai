...
\title{Trinity S$^3$AI}
\subtitle{A Constructive Negative Result in Geometric Unification}
\date{May 2026}
...
% ============================================================
\begin{frame}{Table of No-Go Theorems}
  \begin{center}
    \begin{tabular}{clcc}
      \toprule
      ID & Statement & Status & Ref \\
      \midrule
      NGT-1 & No $\sigma$-field in H$_4$ geometry & \textbf{Qed} & Wave 5.3 \\
      NGT-2 & No 3-generation structure from H$_4$ & \textbf{Qed} & Wave 9 \\
      NGT-3 & D$_4$ KO-dim $5 \pmod 8 \neq 6$ & \textbf{Qed} & Wave 11.2 \\
      NGT-4 & Spectral-action $m_H = 132.88$ GeV & \textbf{Qed} & Wave 11.5 \\
      NGT-5 & E$_6$/E$_7$ plumbing mismatch & \textbf{Qed} & Wave 12.5 \\
      \bottomrule
    \end{tabular}
  \end{center}
  \vfill
  ...
  \end{block}
\note{Five No-Go theorems, all Qed. Every refutation is a formal theorem. Core message: hypothesis died with a certificate.}
\end{frame}
...
\begin{frame}{Conclusion: What Survives?}
  \begin{columns}
    \begin{column}{0.48\textwidth}
      ...
      \begin{itemize}
        ...
        \item Four rigorous No-Go theorems
      \end{itemize}
    \end{column}
    \begin{column}{0.48\textwidth}
  ...
  \begin{block}{Honest summary}
    Trinity S$^3$AI is a \textbf{constructive negative result}.\\
    Knowing what does not work is as valuable as knowing what does.
  \end{block}
\note{SURVIVES: KO-dim 6; η=−2 APS-exact; 2I ⊂ SU(2) motivates ℍ; machine-verified honesty framework; 4 No-Go theorems. DOES NOT SURVIVE: H₄ derives SM → refuted; H₄ predicts 125 GeV → retrospective fit; Tier-3 cosmology → falsified by Planck/DESI. Honest summary: constructive negative result. Knowing what does not work is as valuable as knowing what does.}
\end{frame}
