% LEGACY DOCUMENT (historical talk wave13)
% Current status: This talk contains claims that have been withdrawn or refuted.
...
\begin{frame}{Open Questions}
  ...
  \end{center}
\note{1-loop Higgs correction: OPEN. E₆/E₇ explicit D_P: OPEN. 81 Admitted in Coq + 1 sorry in Lean, all logged. Chirality from η=−2: OPEN. DUNE 2028 will measure δ_CP independently. The Trinity δ_CP = 65.66° prediction is WITHDRAWN (>5σ excluded by current data). All predictions registered in PREDICTIONS_REGISTRY.md.}
\end{frame}
