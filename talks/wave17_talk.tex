...
\begin{frame}{Table of No-Go Theorems}
  \begin{center}
    \begin{tabular}{clcc}
      ...
      NGT-7 & F$_4$ Yukawa hierarchy fails & \textbf{Numerical} & Wave 16.1 \\
      \bottomrule
    \end{tabular}
  \end{center}
  \vfill
  ...
  \end{block}
\note{Six No-Go theorems, 5 Qed + 1 numerical. Every refutation is a formal theorem or documented numerical test. Core message: hypothesis died with a certificate.}
\end{frame}
...
\begin{frame}{Experimental Tracker Update (2026)}
  ...
  \end{center}
\note{JUNO Δm²₂₁ consistent at 0.25σ. DESI normal hierarchy consistent. DUNE δ_CP >3σ tension persists. Binary verdict 2028-2032.}
\end{frame}
...
\begin{frame}{Open Questions}
  \begin{enumerate}
    ...
    \item \textbf{DUNE 2028:} $\delta_{CP} = 65.66^\circ$ is $>$$3\sigma$ from global fits. Will it survive?
  ...
  \end{center}
\note{E₈ B-matrix: OPEN. 1-loop Higgs: OPEN. Chirality from η=−2: OPEN. DUNE δ_CP >3σ tension: will it survive? 0 Admitted achieved; 77 Axioms remain.}
\end{frame}
...
\begin{frame}{Conclusion: What Survives?}
  \begin{columns}
    \begin{column}{0.48\textwidth}
      ...
      \begin{itemize}
        ...
        \item Six rigorous No-Go theorems
  ...
  \end{block}
\note{SURVIVES: KO-dim 6; η=−2 APS-exact; 2I ⊂ SU(2) motivates ℍ; machine-verified honesty; 6 No-Go theorems; 0 Admitted. DOES NOT SURVIVE: H₄ derives SM → refuted; H₄ predicts 125 GeV → retrospective fit; F₄ rescues 3 generations → refuted; Tier-3 cosmology → falsified.}
\end{frame}
